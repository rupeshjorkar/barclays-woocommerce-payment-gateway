...
class WC_Gateway_Cybersource_Barclays extends WC_Payment_Gateway {
    ...
    public function sign ($params) {
      return $this->signData($this->buildDataToSign($params), $this->get_secret_key());
    }
...
<?php
	...
	public function payment_page( $order_id )
	{
		...
		//	'unsigned_field_names' => 'card_number,card_expiry_date,card_type,card_cvn',
			...
			'transaction_type' => $this->transaction_type,
		     'reference_number' => uniqid().'_'.$order->get_ID(),
		...
		$data_to_post = array_merge( $data_to_merge, array( "signature" => $this->sign( $params ) ) );
	...
	<form action="<?php echo $this->get_action_url(); ?>" method="POST" class="checkout_cybersource_barclays" >
...
?>
		...
		<!--<img id="barclays_bank_logo" style="float:right;box-shadow:none;width: 60px;" src="https://shop.biblesociety-kenya.org/wp-content/plugins/BarclaysWooCommercePaymentGateway-master/images/logo.png" title="Checkout 1">		-->
...
<br>
	<?php
		...
		/**
	 * Relay response - handles return data
	 */
